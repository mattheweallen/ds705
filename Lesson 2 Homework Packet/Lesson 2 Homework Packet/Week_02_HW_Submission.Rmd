...
power.t.test(n = 37, delta = 10, sd = 37.1, sig.level = 0.1, type = "one.sample", alternative = "one.sided")
```
...
power.t.test(power = .9, delta = 10, sd = 37.1, sig.level = 0.1, type = "one.sample", alternative = "one.sided")
```
