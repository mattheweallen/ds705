...
ggplot(data = WormSheep, aes(x = treated, y = worms)) + geom_boxplot() + labs(x = "", y = "Worm Count")
plotHistTreated <- ggplot(data = WormSheep[WormSheep$treated=="treated",], aes(x = worms)) +
  geom_histogram(binwidth = 10, colour = "black") + labs(x = "Worms", y = "Count") +
  ggtitle("Treated") +
  theme(plot.title = element_text(hjust = 0.5))

plotHistUntreated <- ggplot(data = WormSheep[WormSheep$treated=="untreated",], aes(x = worms)) +
  geom_histogram(binwidth = 10, colour = "black")  + labs(x = "Worms", y = "Count") +
  ggtitle("Untreated") +
  theme(plot.title = element_text(hjust = 0.5))

grid.arrange(plotHistTreated, plotHistUntreated, ncol = 2)
