...
hist(WormSheep$worms[WormSheep$treated=="treated"],main="Worm Count for Treated Group",breaks = bins,xlab="Worm Count", prob=TRUE, ylab = "")
hist(WormSheep$worms[WormSheep$treated=="untreated"],main="Worm Count for Untreated Group",breaks = bins,xlab="Worm Count", prob=TRUE, ylab = "")
boxplot(WormSheep$worms~WormSheep$treated,names=c("Treated","Untreated"),ylab="Worm Count",main="Worm Count for Treated vs Untreated")
# reset to one plot
par(mfrow=c(1,1))
