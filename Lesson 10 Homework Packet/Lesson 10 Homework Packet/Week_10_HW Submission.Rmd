...
Visually the variability looks different between distributions especially Cm, Lg, and Md. Md and Lg appear skewed.

Use the shapiro test to validate.
...
Based on the Shapiro Test, it is reasonable to assume all the RPM distributions are normal and have equal variances for the different types of cars.
...
The mean for Lg is significantly different than for Md, Sm, and Sp.
...
bootMedDiff <- function(d,i){
  ...
  #c( meds[4]-meds[1], meds[4]-meds[2], meds[1]-meds[2])
  }
```
