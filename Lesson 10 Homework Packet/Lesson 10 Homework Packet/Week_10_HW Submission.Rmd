...
The company should use FDR. The false discovery rate is not as big a problem when in the preliminary phase, because the company is looking for candidate compounds for further research.
...
It is not reasonable to assume all the RPM distributions are normal and have equal variances for the different types of cars. Visually the variability looks different between distributions especially Cm, Lg, and Md. Md and Lg appear skewed.
