...
The classification threshold that produces the maximum profit is .76, which gives an accuracy of 65%.

Given a bad loan, the model will correctly predict it 54% of the time.

Given a good loan, the model will correctly predict it 68% of the time.
