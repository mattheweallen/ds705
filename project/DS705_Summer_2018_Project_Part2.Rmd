...
loan.model <- glm(formula = response ~ log_amount + log_payment + log_income + sqrt_openAcc + cube_rt_totalBal + cube_rt_totalLim, family = "binomial", data = train)
```
...
cTab <- table(train$response, predRICH) 
addmargins(cTab)
