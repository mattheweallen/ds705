...
From the summary of the model all the variables are very significant as indicated by small p-values. Based on the VIF, the variables log_payment and log_amount are colinear. However, they are still very sigficant in the model, and will be kept.
