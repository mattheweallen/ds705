...
$$\mu_\mbox{diff} \quad \textrm{is the mean of the difference in perception of a spatted ankle subtracted from the perception of a taped ankle.}$$
...
$$\mu_\mbox{diff} \quad \textrm{is the mean of the difference between paired estimated claims minus its actual.}$$
